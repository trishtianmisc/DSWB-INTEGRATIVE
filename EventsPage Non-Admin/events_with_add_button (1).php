...
if (isset($_POST['submit_event'])) {
    ...
    $insert_sql = "INSERT INTO links (link, title, description, date) VALUES ('$link', '$title', '$description', '$date')";
...
<body>
    ...
    <div class="col-12 event-card">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-12">
          ...
          <img src="Images/event1.jpg" class="img-fluid">
        ...
        <div class="col-md-8 col-12">
          ...
          <div class="row">
            ...
            <div class="col-12 mt-md-0 mt-2">
              ...
              <button type="button" class="btn btn-warning">Events</button>

            </div>

            <div class="col-12 mt-2">

              <h3>DSWD, UNICEF sign MOU for responsive social protection system during disasters</h3>

            </div>

            <div class="col-12 mt-2">

              <h6>Department of Social Welfare and Development (DSWD) Secretary Rex Gatchalian and United Nations Children’s Fund (UNICEF) Philippine Country Representative Oyunsaikhan Dendevnorov sign a Me</h6>
    ...
    <div class="col-12 event-card mt-4">
      <div class="row">
        ...
        <div class="col-md-6 col-12">
          ...
          <div class="mt-3">
            <button type="button" class="btn btn-warning">Events</button>
            <h3 class="mt-2">DSWD, UNICEF sign MOU for responsive social protection system during disasters</h3>
            <h6 class="mt-2">
              Department of Social Welfare and Development (DSWD) Secretary Rex Gatchalian and United Nations Children’s Fund (UNICEF) Philippine Country Representative Oyunsaikhan Dendevnorov sign a memorandum of understanding for a responsive social protection system during disasters.
            </h6>
            <button type="button" class="btn btn-secondary mt-4">READ MORE</button>
          </div>
        </div>
        ...
        <div class="col-md-6 col-12 mt-3 mt-md-0">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!4v1746190555744!6m8!1m7!1shx2RmXo9RborICuVj3ogRA!2m2!1d10.29164530058785!2d123.9688499388615!3f91.70043230859898!4f0!5f0.7820865974627469https://www.google.com/maps/embed?pb=!4v1746190555744!6m8!1m7!1shx2RmXo9RborICuVj3ogRA!2m2!1d10.29164530058785!2d123.9688499388615!3f91.70043230859898!4f0!5f0.7820865974627469" 
            width="100%" 
            height="300" 
            style="border:0;" 
            allowfullscreen="" 
  ...
  <!-- End of Footer Container Code -->
 

  <script src="events.js"></script> <!-- Own Javascript -->
  ...
  <div class="modal-dialog">
    <form method="POST" action="" class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
          <label for="link" class="form-label">Google Maps iframe Embed</label>
